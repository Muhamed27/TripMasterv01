...
/* 
  הוספת סיפור חדש (מעמוד HistoryPlans → Share)
  קלט (POST, FormData):
    user_id (חובה), trip_id (רשות), title, rating (1..5), notes, country,
    eventCalender (JSON אופציונלי), start_date, end_date,
    photos[] (רשות)
  פלט: { ok:true, id:<story_id> }
*/

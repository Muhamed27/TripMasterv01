...
import italy from "./Images/Culinary Rome.png";
...
const PlanMyTrip = () => {
  ...
  const fetchCoordinates = async () => {
    const apiKey = "AIzaSyAOIctlDP-XpDsfY_VFnPzyhrPj3Y2TtQc";
  ...
  const fetchGooglePlaces = async () => {
    ...
    const apiKey = "AIzaSyAOIctlDP-XpDsfY_VFnPzyhrPj3Y2TtQc"; // מפתח API מגוגל
    let googlePlaces = [];
  ...
  const fetchEvents = async () => {
    let apiKey = "I8yPidlkbkvGeGPJmi3gAglYa1fwftA8";
    let events = [];
  ...
  const fetchRandomCity = async () => {
    try {
      ...
      const url =
        "http://localhost:8012/www/tripmasterv01/public/GetRandomCity.php";
  ...
  const fetchSuggestedCities = async () => {
    ...
    try {
      const url = `http://localhost:8012/www/tripmasterv01/public/GetRandomCities.php`;
      const data = new FormData();

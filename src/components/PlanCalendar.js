...
const PlanCalendar = ({
  ...
  const sendEventCalenderToDb = async () => {
    ...
    data.append("id", id);
    const url =
      "http://localhost:8012/www/tripmasterv01/public/UploadToDashboardEventCalender.php";
    try {
    ...
    <div>
      {editPress && (
        <div className="page-container">
          <div className="calendar-container">          <FullCalendar
            ref={calendarRef}
            ...
            eventReceive={(info) => {
              ...
              info.event.setExtendedProp("description", eventData.description);
